...
for(let i = 0; i < data.length; i++){ 
	if (largest == data[i]){
	txt += "<tr><td style='color:#00ff00'> " + data.indexOf(data[i]) + " </td> " + " <td style='color:#00ff00'> " + (data[i]*100).toFixed(2) + " </td></tr>";
	} else
	txt += "<tr><td style='color:#ff0000'> " + data.indexOf(data[i]) + " </td> " + " <td style='color:#ff0000'> " + (data[i]*100).toFixed(2) + " </td></tr>";
	document.getElementById("predicted_array").innerHTML = txt;
}
}
